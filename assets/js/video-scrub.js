...
(function () {
  ...
  if (mobile) {
    /* Héroe estático de 88vh (ver CSS): el scroll-scrub en móvil se probó
       dos veces y en ambos sentidos dio problemas reales — primero lag
       por el seek continuo, y al "arreglarlo" imitando a escritorio el
       video se quedaba en negro/transparente en varios navegadores
       móviles (no pintan fotogramas de un <video> que nunca se reprodujo).
       En vez de seguir persiguiendo esto, en móvil el video simplemente
       se reproduce normal y en bucle — sin animación de scroll. */
    video.loop = true;
